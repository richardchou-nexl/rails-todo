...
module ActionController::Base::HelperMethods
  ...
  # source://actionpack/8.0.2/lib/action_controller/metal/flash.rb#41
  def alert(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.2/lib/abstract_controller/caching/fragments.rb#34
  def combined_fragment_cache_key(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.2/lib/action_controller/metal/content_security_policy.rb#13
  def content_security_policy?(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.2/lib/action_controller/metal/content_security_policy.rb#14
  def content_security_policy_nonce(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.2/lib/action_controller/metal/cookies.rb#10
  def cookies(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.2/lib/action_controller/metal/request_forgery_protection.rb#102
  ...
  # source://actionpack/8.0.2/lib/action_controller/metal/request_forgery_protection.rb#103
  ...
  # source://actionpack/8.0.2/lib/abstract_controller/caching.rb#45
